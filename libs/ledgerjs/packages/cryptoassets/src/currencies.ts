...
export const cryptocurrenciesById: Record<CryptoCurrencyId, CryptoCurrency> = {
  ...
  pulsechain: {
    ...
    explorerViews: [
      {
        tx: "https://ipfs.scan.pulsechain.com/tx/$hash",
        address: "https://ipfs.scan.pulsechain.com/address/$address",
        token: "https://ipfs.scan.pulsechain.com/token/$contractAddress",
      },
    ],
